...
public class Assignment extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Insert number of Row");

        jLabel2.setText("Insert number of Column");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(41, 41, 41)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(column, javax.swing.GroupLayout.DEFAULT_SIZE, 38, Short.MAX_VALUE)
                            .addComponent(row)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(56, 56, 56)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int rw = Integer.parseInt(row.getText());
        int cl = Integer.parseInt(column.getText());
        //this.setNumVert(nv);
        AssignmentMatrix m = new AssignmentMatrix(rw,cl);
        m.setVisible(true);
        this.setVisible(false);
